...
# You must set these
APP_KEY = "cx5zygh4caj53ua"
APP_SECRET = "p9v34zcifm34i1q"
...
class DropboxController < ApplicationController
  def authorize
    if not params[:oauth_token] then
      ...
      redirect_to :action => 'display_tokens'
    end
  end
  ...
  def display_tokens
    ...
    render :text => "accessKey=#{access_token.key} accessSecret=#{access_token.secret}"
  end
